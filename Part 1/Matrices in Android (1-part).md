...
Хорошо, а теперь расмотрим какие темы будут расматриваться на протяжении всех частей.
...
  Смысл параметров массива рассмотри чуть позже, а сейчас предлагаю ознакомиться с основными методами класса Matirx.java.  
    
### Post и Pre функции трансформаций в Android

Предполагаю, что вы кратенько изучили документацию от Google по классу матриц.
